...
plt.savefig('E:/Programming/Claude/A股基本面分析作品集/fig1_缺失率对比.png', dpi=150, bbox_inches='tight')
plt.close()
print('图1 缺失率对比 已保存')
...
plt.tight_layout()
plt.savefig('E:/Programming/Claude/A股基本面分析作品集/fig2_行业分布.png', dpi=150, bbox_inches='tight')
plt.close()
print('图2 行业分布 已保存')
...
plt.tight_layout()
plt.savefig('E:/Programming/Claude/A股基本面分析作品集/fig3_行业箱线图.png', dpi=150, bbox_inches='tight')
plt.close()
print('图3 行业箱线图 已保存')
...
plt.tight_layout()
plt.savefig('E:/Programming/Claude/A股基本面分析作品集/fig4_缩尾对比.png', dpi=150, bbox_inches='tight')
plt.close()
print('图4 缩尾对比 已保存')
